	...
	if ($sessid eq '' or ($sesslong-$sesstime)>$sessionlong)
		...
		#Вывод заголовков
			...
			{   
			    ...
			    print "</td></tr></table></form></span></div>";
			    print "<div class=\"sidemenu\"></div><div class=\"text\">";
				...
				print "<a href=\"".$sitename."/cgi-bin/catel.pl\">Подробнее</a></td></tr>";
